...
## Infraestrutura
- `mach1` (192.168.0.251): Controle (Ansible + Guacamole)
- `mach2` (192.168.0.252): Gerenciado
- `mach3` (192.168.0.253): Gerenciado (**11/11/2025:** reinstalado como standby; monitorar disco até troca preventiva)
...
192.168.0.252 ansible_user=alessandro
192.168.0.253 ansible_user=alessandro
```
