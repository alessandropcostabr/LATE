// config/loadEnv.js
// Carrega variáveis de ambiente do arquivo adequado (.env, .env.prod, etc.).
...
function loadEnv(options = {}) {
  ...
  if (!target) {
    if (!alreadyLoaded) {
      console.warn('[env] Nenhum arquivo .env encontrado; usando variáveis existentes do processo.');
    }
    alreadyLoaded = true;
    cachedPath = null;
    return null;
